...
def test_readme_consolidates_guides_and_bookmarks() -> None:
    ...
    for expected in [
        ...
        "agh package assign",
        "agh package activate",
        "agh package deactivate",
        "agh package unassign",
        "agh package describe",
        "pkgv_...",
        "name@version",
        ...
        "Global skills",
        "agh skill list",
        "agh skill install acme/commenting@latest reviewer --target opencode",
        ...
        ".agh-cache/",
        "agh pull --force",
        "agh project describe",
        "agh project member list",
        "AGH-BEGIN",
        "AGH-END",
        'mode = "symlink"',
        'mode = "copy"',
